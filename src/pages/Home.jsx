...
const Home = () => {
  return (
    <>
      <NavbarHome />
      <h1 className='text-center font-bold text-2x1 text-gray-800 pt-5 text-[22px]'>Daftar Indihome Jakarta Barat Di Tahun 2024 Dan Tahun 2025 Rilis Terbaru</h1>
      <div className='container mx-auto px-2 max-w-5xl pt-5 md:pt-32'>
        <img className='w-[60%] mx-auto' src="./Indihome-jakarta-barat.jpg" alt="indihome jakarta barat" />
        <p className='pt-3 pb-2 text-justify'>Suatu Berita Menguntungkan bagi Kamu  Dan Keluarga Kamu yang memerlukan pemasangan Indihome .Segera Daftar  <a className='text-blue-600 hover:text-red-600' href="https://my-indihome.com/indihome-jakarta-barat/">Indihome Jakarta Barat</a> Di  Tahun 2024 Dan Tahun 2025 secara cepat dan mudah dengan menggunakan website pemasangan Indihome yang kami sediakan untuk kamu ingin memasang wifi indihome di rumah/kantor dan kamar apartemen kamu .</p>
        ...
        <h2 className='text-center font-bold pt-2'>Harga Paket Indihome Jakarta Barat Tahun 2024 Dan Tahun 2025</h2>
        <p className='pt-2 pb-2 text-justify'>Semua harga paket indihome Jakarta Barat 2023 yang kami tampilkan merupakan produk terbaik dan terbaru</p>
        ...
        <p className='pb-2'>Dengan harga promo paket Speedy Indihome di Jakarta Barat Tahun 2024 Dan Tahun 2025 Paket 3P memiliki fitur sebagai berikut:</p>
        <ul className='list-disc ml-5 pb-2'>
